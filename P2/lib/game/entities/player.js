    ...
    EntityPlayer = ig.Entity.extend(
        {
            ...
            //tracks how many flowers the player has collected
            flowercount: 0,

            //if the objective (collect 7 flowers) is completed
            objective: false,

            //boolean variables for determining if the player is in the water entity or air entity
            inWater: false,
            inAir: false,

            //bounce variables setup for climbing the walls in the water section
            bounce: 70,
            bounce1: 100,
            ...
            onDeath: function(){
                ...
                if(ig.game.lives < 0){
                    ...
                    ig.game.spawnEntity( EntityPlayer, 35, 35);
                }
            },
            ...
            update: function()
            {
                ...
                //only allowed to control y accel while in the final section
                else if( ig.input.state('down') && this.inAir == true)
                {
                    this.accel.y = accel;
                }
                else if( ig.input.state('up') && this.inAir == true)
                {
                    this.accel.y = -accel/2;
                }
                else
                {
                    this.accel.x = 0;
                ...
                //adding logic for being within the water entity and bouncing off the walls TURNED OFF BECAUSE IT WAS MAKING PLAYER BOUNCE OFF EVERYTHING
                if(this.vel.y == 0 && this.last.y < this.pos.y && this.inWater == true)
                {
                    this.vel.y = -this.bounce;
                }
                if(this.vel.x == 0 && this.last.x < this.pos.x && this.inWater == true)
                {
                    if(this.inWater == true)
                    {
                        this.vel.y = -200;
                    }
                    this.vel.x = -this.bounce1;
                }
                if(this.vel.x == 0 && this.last.x > this.pos.x && this.inWater == true)
                {
                    if(this.inWater == true)
